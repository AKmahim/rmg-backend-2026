...
@section('title', 'Spinner Data Management')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Spinner Data</li>
                    </ol>
                </div>
                <h4 class="page-title">Spinner Data Management</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('spinner.index') }}" method="GET" class="mb-3" id="filterForm">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-2 d-flex gap-2" style="gap:6px">
                    ...
                    <div class="mt-3 d-flex justify-content-between align-items-center">
                        <small class="text-muted">
                            Showing {{ $spinners->firstItem() }}–{{ $spinners->lastItem() }} of {{ $spinners->total() }} records
                        </small>
                        {{ $spinners->appends(request()->query())->links('pagination::bootstrap-4') }}
                    </div>
